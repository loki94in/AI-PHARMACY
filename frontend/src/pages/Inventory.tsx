          ...
          <table className="w-full text-left border-collapse">
            <thead className="sticky top-0 bg-[#18181b]/95 backdrop-blur z-10">
              <tr>
                ...
                <th className="p-4 text-xs font-bold text-muted uppercase tracking-wider border-b border-glass-border">Item Code</th>
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan={9} className="p-8 text-center text-muted">Loading inventory...</td></tr>
              ) : filteredItems.length === 0 ? (
                <tr><td colSpan={9} className="p-8 text-center text-muted">No medicines found.</td></tr>
              ) : (
                filteredItems.map(item => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-4 text-sm text-muted">{item.item_code || '-'}</td>
