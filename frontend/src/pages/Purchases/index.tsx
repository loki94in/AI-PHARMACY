                ...
                return (
                  ...
                  <td className="py-3">
                    <input
                      ...
                      className="w-20 bg-white/10 border border-white/20 rounded px-2 py-1 text-white text-sm font-mono text-center"
                    />
                  </td>
                  <td className="py-3 relative group/btn">
                    <div className="flex items-center bg-white/10 border border-white/20 rounded px-1.5 py-1 w-[110px] focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500 transition-all">
                      {mrpVal > 0 && (
                  ...
                  <td className="py-3">
                    <input
                      ...
                      className="w-20 bg-white/10 border border-white/20 rounded px-1 py-1 text-white text-sm text-center"
                    />
                  </td>
                  <td className="py-3">
                    <input
