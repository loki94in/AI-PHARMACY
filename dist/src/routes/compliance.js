...
router.post('/add-schedule-h1', async (req, res) => {
    ...
    try {
        ...
        await db.run('INSERT INTO action_logs (date, product, patient_id, doctor_id, license_no, qty, bill_no) VALUES (DATE("now"), ?, ?, ?, "SCH-H1", 1, "SCH-H1-DISP")', [drug_name, patient_name, doctor_name]);
        await db.close();
